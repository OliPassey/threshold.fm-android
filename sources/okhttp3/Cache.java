...
public final class Cache implements Closeable, Flushable {
    ...
    class C00881 implements InternalCache {
        C00881() {
        }
    ...
    class C00892 implements Iterator<String> {
        boolean canRemove;
        final Iterator<Snapshot> delegate = Cache.this.cache.snapshots();
        String nextUrl;

        C00892() throws IOException {
        }
        ...
        public Entry(Source in) throws IOException {
            try {
                ...
                if (isHttps()) {
                    ...
                    if (blank.length() > 0) {
                        throw new IOException("expected \"\" but was \"" + blank + Common.QUOTE);
                    }
    ...
    static int readInt(BufferedSource source) throws IOException {
        try {
            ...
            throw new IOException("expected an int but was \"" + result + line + Common.QUOTE);
        } catch (NumberFormatException e) {
            throw new IOException(e.getMessage());
        }
    }
