...
public class List extends AbsObjectWrapper<java.util.List<Object>> implements IterableList {
    ...
    class C00551 implements Comparator<Comparable> {
        C00551() {
        }
    ...
    class C00573 implements Comparator<Comparable> {
        C00573() {
        }
    ...
    class C00584 implements Comparator<Comparable> {
        C00584() {
        }
    ...
    public void Sort(boolean Ascending) {
        if (Ascending) {
            ...
            Collections.sort((java.util.List) getObject(), new C00551());
        }
    }
    ...
    public void SortCaseInsensitive(boolean Ascending) {
        if (Ascending) {
            Collections.sort((java.util.List) getObject(), new C00573());
        } else {
            Collections.sort((java.util.List) getObject(), new C00584());
        }
    }
}
